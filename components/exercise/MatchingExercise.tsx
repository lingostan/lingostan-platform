      ...
      <View style={styles.columns}>
        <View style={styles.column}>
          {leftItems.map(leftValue => {
            ...
            const label = showAudioOnlyLeft ? undefined : (hasAudio ? pair.left.value : displayText);
            const showIcon = hasAudio;
        ...
        <View style={styles.column}>
          {rightItems.map(rightValue => {
            ...
            // Если есть audioUrl, показываем и иконку, и текст из value
            const label = showAudioOnlyRight ? undefined : (hasAudio ? pair.right.value : displayText);
            const showIcon = hasAudio;
