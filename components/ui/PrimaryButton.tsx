...
export const PrimaryButton: React.FC<PrimaryButtonProps> = ({
  ...
  const getShadowStyle = () => {
    if (mode === 'filled' && shadow) {
      // Преобразуем rgb цвет в rgba для boxShadow
      // shadow может быть в формате 'rgb(r, g, b)' или 'rgba(r, g, b, a)'
      ...
      return {
        boxShadow: `0px 4px 6px ${rgbToRgba(shadow, 0.2)}`,
      };
    }
    return {};
  };
