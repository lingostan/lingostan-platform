...
// Моки используются только если явно указано EXPO_PUBLIC_USE_MOCK_API === 'true'
// По умолчанию все запросы идут на реальный API
declare const __DEV__: boolean | undefined;
const isDevelopment = process.env.EXPO_PUBLIC_USE_MOCK_API === 'true';
