    ...
    return (
        <SafeAreaView style={[styles.container, { paddingTop: insets.top }]}>
            <View style={styles.header}>
                <BaseText variant='headingM' style={styles.title}>Лакский Алфавит</BaseText>
                <Progress.Bar progress={progress} width={null} height={10} color="#6CD96C" unfilledColor="#E0E0E0" borderColor="transparent" />
            </View>
            <ScrollView 
